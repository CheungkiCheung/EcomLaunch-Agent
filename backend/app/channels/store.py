"""ChannelStore — persists IM chat-to-OpenSKU thread mappings."""
...
class ChannelStore:
    """JSON-file-backed store that maps IM conversations to OpenSKU threads.
    ...
    def get_thread_id(self, channel_name: str, chat_id: str, topic_id: str | None = None) -> str | None:
        """Look up the OpenSKU thread_id for a given IM conversation/topic."""
