...
definition is currently disabled for EcomLaunch.
...
- `subagents.ecom-launch.yaml`: four retained specialist definitions; EcomLaunch currently enables the first three.
...
EcomLaunch specialist or delivery requirement.
