---
title: 第一次对话
description: 本教程引导你在 OpenSKU 中完成第一次完整的 Agent 对话，从启动应用到与 Agent 进行实质性任务交互。
---

# 第一次对话

本教程引导你在 OpenSKU 中完成第一次完整的 Agent 对话，从启动应用到与 Agent 进行实质性任务交互。

## 前置条件

- OpenSKU 应用已运行（参见[快速上手](/docs/application/quick-start)）
