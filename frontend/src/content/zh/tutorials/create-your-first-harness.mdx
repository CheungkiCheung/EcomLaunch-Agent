...
description: 本教程介绍如何以编程方式使用 OpenSKU Harness Python SDK——直接在你的 Python 代码中导入和使用 OpenSKU，而不是通过 Web 界面。
---

# 创建你的第一个 Harness

本教程介绍如何以编程方式使用 OpenSKU Harness Python SDK——直接在你的 Python 代码中导入和使用 OpenSKU，而不是通过 Web 界面。
