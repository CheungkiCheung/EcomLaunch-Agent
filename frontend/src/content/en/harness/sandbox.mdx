...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes OpenSKU capable of real action, not just
  conversation.
</Callout>
...
OpenSKU supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: opensku-sandbox)
