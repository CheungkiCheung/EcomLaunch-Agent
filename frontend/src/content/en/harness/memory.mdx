---
title: Memory
description: Memory is a runtime feature of the OpenSKU Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
---
...
<Callout type="info" emoji="💾">
  Memory lets OpenSKU carry useful information across sessions. The agent
...
Memory is a runtime feature of the OpenSKU Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
...
OpenSKU supports two levels of memory:
