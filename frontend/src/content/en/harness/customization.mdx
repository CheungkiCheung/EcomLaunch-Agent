---
title: Customization
description: OpenSKU's pluggable architecture means most parts of the system can be replaced or extended without forking the core. This page maps the extension points and explains how to use each one.
---
...
<Callout type="info" emoji="🔧">
  OpenSKU is designed to be adapted. You can extend agent behavior by writing
...
OpenSKU's pluggable architecture means most parts of the system can be replaced or extended without forking the core. This page maps the extension points and explains how to use each one.
