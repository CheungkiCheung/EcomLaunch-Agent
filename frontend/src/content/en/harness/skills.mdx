...
OpenSKU ships with the following public skills:
...
- **Through the OpenSKU App UI**: the skills panel lets you toggle skills on and off.
...
OpenSKU includes an optional **skill evolution** feature that allows the agent to autonomously create and improve skills in the `skills/custom/` directory:
