---
title: OpenSKU App
description: OpenSKU App is the reference implementation of what a production OpenSKU experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  OpenSKU App is a complete Super Agent application built on top of OpenSKU
...
OpenSKU App is the reference implementation of what a production OpenSKU experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The OpenSKU App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, OpenSKU Harness                               |
| Reverse proxy     | nginx                                                                |
