...
description: This tutorial shows you how to use the OpenSKU Harness programmatically — importing and using OpenSKU directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the OpenSKU Harness programmatically — importing and using OpenSKU directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- OpenSKU repository cloned
