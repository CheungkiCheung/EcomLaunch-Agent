...
description: This tutorial walks you through your first complete agent conversation in OpenSKU — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in OpenSKU — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- OpenSKU app is running (see [Quick Start](/docs/application/quick-start))
...
The agent used the OpenSKU Harness to:
