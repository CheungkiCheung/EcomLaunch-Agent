...
description: This tutorial shows you how to configure and use tools and skills in OpenSKU to give the agent access to web search, file operations, and domain-specific capabilities.
---
...
This tutorial shows you how to configure and use tools and skills in OpenSKU to give the agent access to web search, file operations, and domain-specific capabilities.
...
Enable skills through the OpenSKU app's extensions panel, or edit `extensions_config.json` directly.

**Via the app UI:**

1. Open the OpenSKU app
