...
function SidebarProvider({
  ...
  // Draggable sidebar width (px). Persisted per session via CSS variable.
        ...
        >
          ...
          {state === "expanded" && (
            <div
              ...
              className="group/resizer absolute inset-y-0 z-30 w-1.5 cursor-col-resize touch-none select-none"
              style={{ right: "-3px" }}
              onPointerDown={(e) => {
                e.preventDefault();
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        state === "collapsed" && "[&>span:last-child]:hidden",
        className,
      )}
      {...props}
    />
