...
This helper is intentionally manual. OpenSKU runtime does not probe Keychain.
Use this script when you want to bridge an existing Claude Code login into an
environment variable or an exported credentials file for OpenSKU.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manually export Claude Code OAuth credentials from macOS Keychain for OpenSKU.",
    )
    parser.add_argument(
        "--service",
